...
<ul>
    ...
    <div className="elem">
     <Link to={"/Internship"}>   <p id='int' className='' onClick={showInternShips} > Internships  <i onClick={hideInternShips}  id='ico' class="bi bi-caret-down-fill"></i></p></Link>
       <Link to={"/Jobs"}> <p onClick={showJobs} >Jobs  <i class="bi bi-caret-down-fill" id='ico2' onClick={hideJobs}></i></p></Link>
    </div>
